...
Component.options.__file = "resources/js/pages/Home/Support.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-16094d08", Component.options)
  } else {
    hotAPI.reload("data-v-16094d08", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_Mixins_validation_error__ = __webpack_require__(1229);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vform__ = __webpack_require__(1228);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    resetForm: function resetForm() {
      this.form = new __WEBPACK_IMPORTED_MODULE_2_vform__["Form"]({
        name: "",
        email: "",
        subject: "",
        message: ""
    ...
    submit: function submit() {
      ...
      if (!self.errors.any()) {
        axios.post(route("api.@contact"), self.form).then(function () {
          self.resetForm();
          self.$router.push("/");
        }).catch(function () {});
      }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-16094d08", module.exports)
  }
}
