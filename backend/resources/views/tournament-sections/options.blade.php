...
?>
<div class="container-fluid detail-box-fixed t-d _options_div" id="options-{{$tour->id}}" style="display:none;">
        ...
        <div class="col-lg-2">
            <ul class="navbar-nav1 s2">
                <li class="nav-item active s2-1">
                    <a style="" class="nav-link s2-1-1 _option" data-control="#overview-{{$tour->id}}">Overview</a>
                    ...
                    <a style="margin-top:-20px" class="nav-link s2-1-1 _option" data-control="#all-rewards-{{$tour->id}}">SEE ALL REWARDS</a>
                </li>
            </ul>
        </div>
        <div class="col-lg-3 ">
            <ul class="navbar-nav1 s2" id="tournamentlist">
                ...
                <li class="nav-item active s2-1">
                    <!--<a style="" id="daily" class="nav-link s2-1-1" >Daily Tournaments</a>
                    <a style="margin-top:-20px" class="nav-link s2-1-1" id="weekly">Weekly Tournaments</a>
                    <a style="margin-top:-20px" class="nav-link s2-1-1" id="monthly">monthly Tournaments</a>-->
        ...
        <div class="col-lg 4" id="">
            <div class="row">
                ...
                <div class="col-lg-6 s5">
                    <!-- <h4 class="s5-1">place: <span class="s5-1-1" style="color:#bf1438">289</span></h4><br>
                     <h4 class="s5-1">WL: <span class="s5-1-1"  style="color:#bf1438">304.00</span></h4><br>
                     <h4 class="s5-1">WR: <span class="s5-1-1"  style="color:#bf1438">34.00</span></h4><br>-->
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid detail-box _details" style="display:none;margin-top:-10px;height:auto" id="overview-{{$tour->id}}">
    <div class="container detail-box">
        ...
        <div class="row">
            @auth
                ...
                @if($members)
                    <div class="col-lg-12">
                        <button class="btn mybtn-tournament" data-toggle="modal" data-target="#team-members-{{$tour->id}}" type="button">TEAM DETAILS</button>
                    </div>
                    @include('modal.invite-modal',['members'=>$members,'id'=>$tour->id])
                @else
                    @if ($tour->isUpcoming())
                        <div class="col-lg-12">
                            <button class="btn mybtn-tournament" type="button" data-toggle="modal" data-target="#make-team-{{$tour->id}}">MAKE TEAM</button>
                        </div>
                        <div class="col-lg-12">
...
<div class="container-fluid detail-box _details" style="display:none;margin-top:-10px;" id="teams-{{$tour->id}}">
    <div class="container detail-box-fixed">
        <div class="row">
