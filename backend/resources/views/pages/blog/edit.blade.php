@extends('layouts.app', ['page' => __('Edit Blog Post'), 'pageSlug' => 'post'])
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="title" class="form-control{{ $errors->has('bracket_size') ? ' is-invalid' : '' }}" placeholder="{{ __('Post Title') }}" value="{{ $post->title }}">
                        ...
                        <label>Image <a href="#"><span class="fas fa-question-circle" tool-tip-toggle="tooltip-demo" data-original-title="Leave Empty, If dont want to change"></span></a></label>
