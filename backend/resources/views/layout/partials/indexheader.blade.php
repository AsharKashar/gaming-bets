            ...
            <div class="row">
                ...
                <div class="row">
                            ...
                            <li class="nav-item">
                                    ...
                                    <a class="nav-link " id="game" style="cursor: pointer;">Game
                            ...
                            <div class="col-lg-2 col-sm-2">
                            <ul class="navbar-nav1" id="gameslist">
                            ...
                            <div class="col-lg-3 col-sm-3">
                                <div class="topbtn">
                            @guest
                                <a href="#" style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;" class="mybtn4" data-toggle="modal" data-target="#login"> sign in</a>
                            @endguest
                            @auth()
                                <a href="{{route("profile")}}" style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;" class="mybtn4" > {{auth()->user()->name}}</a>
                            @endauth
                            </div>
                            </div>
                        </div>
