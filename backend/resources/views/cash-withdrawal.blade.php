...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb-list">
                        ...
                        <li>
                            <a href="/cash-withdrawal">Cash withdrawal</a>
                        </li>
                    </ul>
                </div>
    ...
    <!-- faq-section start -->
    <section class="faq-section " syle="padding-bottom:100%">
        <div class="container">
            <!--<div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    <div class="section-heading">
                        ...
                        <p class="text">
                            convert the lima coins to real cash with Banger example?                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        .
                        </p>
                    </div>
                </div>
            </div>-->
						...
						<div class="col-lg-12">
							<div class="subscribe-boxe" >
								...
								<div class="row justify-content-between">
									...
									<!--<div class="col-lg-0 d-flex align-self-center">




                            <div class="top-area">
                                <img   style="width:100px;height:100px;"  src="{{url('/storage/'.$user->image)}}" onerror="this.onerror=null; this.src='assets/images/affiliate/ps1.png'" class="img-thumbnail" alt="Profile Picture">-->
                            <!--<div class="left">

                                <h4 class="name" style="padding-top:10px;padding-left:20px">
                                    {{$user->name}}
                                </h4>
                           ...
                           <!-- </div>
                            <div class="bottom-area"style="padding-top:20px">
                                <div class="left" >
                                    ...
                                    <p style="margin-top:30px;margin-left:30px"><img src="assets/images/bomb@2x.png" style="height:90px">	&nbsp;Total Bomb :<i class="fas fa-coins"></i> {{$user->total_prize}}</p>
...
<div style="float:right" class="col-lg-4 ">
                                                        <div class="form-group" >
                                                            <button style="width:30" type="mybtn6" class="mybtn1">Claim</button>
                                                        </div></div>
                                                    </form>
                                                </div>
                                            </div>
                            ...
                            <center><h3>Payment History</h3></center><br>
